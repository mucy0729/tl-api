...
class UnfreezeMoneyRequest extends BaseRequestAttribute
{
    /**
    ...
    /**
     * @Notes:
     * @Interface getBizFreezeNo
     * @return string
     * @author: kai.chen
     * @Time: 2020/7/23   10:15 下午
     */
    public function getBizFreezeNo()
    {
    ...
    /**
     * @Notes:
     * @Interface setBizFreezeNo
     * @param string $biz_freezen_no
     * @return $this
     * @author: kai.chen
     * @Time: 2020/7/23   10:15 下午+
     */
    public function setBizFreezeNo($biz_freezen_no = '')
    {
        $this->biz_freezen_no = $biz_freezen_no;
